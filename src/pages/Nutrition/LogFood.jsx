...
import { ArrowLeft, Search, ScanBarcode, Plus, Sparkles, X } from 'lucide-react'
...
export default function LogFood() {
  ...
  const [selectedMealType, setSelectedMealType] = useState(() => location.state?.mealType || inferMealType())
  ...
  return (
    <div className="relative min-h-[calc(100vh-100px)] flex flex-col">
      ...
      <div className="space-y-6 max-w-2xl mx-auto pb-20 w-full">
        <h1 className="text-2xl font-bold text-text-primary px-2">Log Food</h1>
